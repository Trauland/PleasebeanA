...
set_property PACKAGE_PIN E19 [get_ports {command[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {command[0]}]
set_property PACKAGE_PIN U19 [get_ports {command[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {command[1]}]
set_property PACKAGE_PIN V19 [get_ports {command[2]}]
...
#Pmod Header JB
#Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {mic}]
